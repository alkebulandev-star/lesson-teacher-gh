...
window.LT_LANGUAGES = {
  ...
  {dag:'Mema wo aha',      en:'Good afternoon',        note:''},
      {dag:'Mema wo edzew',    en:'Good evening',          note:''},
      {dag:'Yaa nua',          en:'Hello (sibling/peer)',  note:'Friendly form'},
      {dag:'Wo ho te dɛn?',    en:'How are you?',          note:'Common'},
      {dag:'Me ho yɛ',         en:'I am fine',             note:'Standard reply'},
      {dag:'Medaase',          en:'Thank you',             note:'Same as Twi'},
      {dag:'Akwaaba',          en:'Welcome',               note:'Famous Akan welcome'},
      {dag:'Nantsew yie',      en:'Goodbye',               note:'Lit. "walk well"'},
    ],
    phrases:[
      {dag:'Me dzin dze…',     en:'My name is…'},
      {dag:'Wo edzidzi anaa?', en:'Have you eaten?'},
      {dag:'Medɔ wo',          en:'I love you'},
      {dag:'Me hia mboa',      en:'I need help'},
      {dag:'Ɔwɔ hen?',         en:'Where is it?'},
      {dag:'Ɛyɛ sɛn?',         en:'How much is it?'},
    ],
    tip:'Tip: Fante shares many words with Twi but uses different vowel sounds and tones. The coastal accent is musical and rhythmic.'
  },
  {dag:'Ina kwana',        en:'Good morning',          note:'Lit. "How was the night?"'},
      {dag:'Ina wuni',          en:'Good afternoon',        note:''},
      {dag:'Ina yini',         en:'Good evening',          note:''},
      {dag:'Lafiya',           en:'Fine / well',           note:'Standard reply'},
      {dag:'Na gode',          en:'Thank you',             note:''},
      {dag:'Don Allah',        en:'Please',                note:'Lit. "for God\'s sake"'},
      {dag:'Sai an jima',      en:'Goodbye / see you',     note:''},
    ],
    phrases:[
      {dag:'Sunana…',          en:'My name is…'},
      {dag:'Ka ci abinci?',    en:'Have you eaten?'},
      {dag:'Ina son ka',       en:'I love you'},
      {dag:'Ina bukatar taimako',en:'I need help'},
      {dag:'Ina yake?',        en:'Where is it?'},
      {dag:'Nawa ne?',         en:'How much is it?'},
    ],
    tip:'Tip: Hausa is widely spoken across northern Ghana and the Sahel. Useful in markets from Tamale to Bolgatanga and across the Burkina Faso border.'
  },
  portuguese: {
    name:'Portuguese', flag:'🇵🇹', color:'#16a34a',
    intro:'Portuguese connects Europe, Brazil and Lusophone Africa — Angola, Mozambique, Cape Verde and more. Useful for music, travel and business.',
    greetings:[
      {pt:'Olá', en:'Hello', note:'Universal'},
      {pt:'Bom dia', en:'Good morning', note:''},
      {pt:'Boa tarde', en:'Good afternoon', note:''},
      {pt:'Boa noite', en:'Good evening / good night', note:''},
      {pt:'Como estás?', en:'How are you?', note:'Informal'},
      {pt:'Estou bem', en:'I am fine', note:''},
      {pt:'Obrigado / Obrigada', en:'Thank you (male/female speaker)', note:'Speaker gender changes the word'},
      {pt:'Por favor', en:'Please', note:''},
      {pt:'Adeus', en:'Goodbye', note:''},
    ],
    phrases:[
      {pt:'Chamo-me…', en:'My name is…'},
      {pt:'Não entendo', en:'I do not understand'},
      {pt:'Onde fica…?', en:'Where is…?'},
      {pt:'Quanto custa?', en:'How much does it cost?'},
      {pt:'Preciso de ajuda', en:'I need help'},
    ],
    tip:'Tip: Portuguese sounds softer than Spanish. Watch nasal sounds like “ão” in não and pão.'
  },
  japanese: {
